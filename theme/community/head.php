...
<div id="wrapper">
	<aside id="aside">
	    ...
	    <div id="aside_ct">
	        <div class="short_cut">
	            <ul>
	                <li class="f_short_cut"><strong><a href="http://naver.com">내 정보 수정 1</a></strong></li>
	                <li><strong><a href="http://3.39.240.45/bbs/board.php?bo_table=gallery">갤러리</a></strong></li>
	                <li><strong><a href="#">헬로 헬로</a></strong></li>
	            </ul>
	        </div>
	        <div class="aside_lt">
	            <?php
